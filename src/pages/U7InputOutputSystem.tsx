import { Cpu, Network, HardDrive, Zap, ChevronRight, Server, CircuitBoard, Cable, Workflow, Binary, Activity, Clock, Boxes, ArrowLeftRight, Timer, Gauge, Database, Radio, Signal, GitBranch, ArrowRight, Sparkles, Plug, ListOrdered, FileCode, MemoryStick, CheckCircle2, XCircle, AlertCircle } from 'lucide-react';
...
export default function U7InputOutputSystem() {
    // Carousel items for I/O System
    const ioSystemImages = [
        {
        ...
        {
            title: 'DMA',
            description: 'Acceso directo a memoria',
            id: 4,
    ...
    // Stack images for I/O architecture layers
    const stackImages = [
        { id: 1, img: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=500&auto=format' },
        { id: 2, img: 'https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?q=80&w=500&auto=format' },
        { id: 3, img: 'https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?q=80&w=500&auto=format' },
        { id: 4, img: 'https://images.unsplash.com/photo-1563770660941-20978e870e26?q=80&w=500&auto=format' }
    ];
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-background via-[var(--color-teal-3)]/5 to-background">
                ...
                <div className="relative max-w-5xl mx-auto">
                    ...
                    <AnimatedContent direction="vertical" distance={60} delay={0.2}>
                        <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight" style={{ paddingBottom: '0.5rem' }}>
                            <TextType
                                text={['Sistema de Entrada/Salida']}
                                typingSpeed={40}
                                loop={false}
                                showCursor={false}
                    ...
                    <AnimatedContent direction="vertical" distance={40} delay={0.8}>
                        <div className="text-center">
                            <BlurText 
                                text="Descubre cómo la computadora se comunica con el mundo exterior a través de su sistema nervioso: el sistema de Entrada/Salida."
            ...
            <div className="max-w-5xl mx-auto px-8 pb-16">
                {/* Section 7.1: ¿Qué es el Sistema de E/S? */}
                <AnimatedContent direction="vertical" distance={60}>
                    <SectionContainer id="que-es-sistema-es">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <SplitText 
                                text="7.1 ¿Qué es el Sistema de Entrada/Salida?"
                                tag="h2"
                            ...
                            <SpotlightCard className="mb-6" spotlightColor="rgba(0, 186, 180, 0.25)">
                                <InfoCard className="bg-gradient-to-br from-[var(--color-teal-3)]/15 to-[var(--color-teal-2)]/10 border-[var(--color-teal-3)]/30">
                                    <div className="flex items-start gap-4 mb-4">
                                        ...
                                        <div>
                                            <h3 className="text-xl font-semibold text-[var(--color-teal-2)] mb-2">El "Sistema Nervioso" de la Computadora</h3>
                                            <p className="text-base text-white">
                                                El sistema de E/S es responsable de la <strong className="text-[var(--color-teal-2)]">comunicación entre el CPU y el mundo exterior</strong>, permitiendo la interacción con usuarios y otros dispositivos.
                                            </p>
                                        </div>
                                    </div>
                                </InfoCard>
                        ...
                        <div className="grid md:grid-cols-3 gap-6 mb-8">
                            <AnimatedContent direction="horizontal" distance={60} delay={0.1}>
                                <SpotlightCard className="h-full" spotlightColor="rgba(0, 186, 180, 0.3)">
                                    <InfoCard title="Entrada" icon={<ArrowLeftRight className="w-5 h-5" />}>
                                        <p className="mb-3 text-white">
                                            <strong className="text-[var(--color-teal-2)]">Recibir datos y programas</strong> del exterior hacia la computadora.
                                        </p>
                                        <div className="p-3 rounded-lg bg-gradient-to-br from-muted/70 to-muted/30 border border-border/30">
                                            <ul className="space-y-1 text-sm">
                                                ...
                                                <li className="flex items-start gap-2 text-black">
                                                    <ChevronRight className="w-3 h-3 mt-0.5 text-[var(--color-teal-2)] flex-shrink-0" />
                                                    <span>Escáneres, cámaras</span>
                                                </li>
                                                <li className="flex items-start gap-2 text-black">
                                                    <ChevronRight className="w-3 h-3 mt-0.5 text-[var(--color-teal-2)] flex-shrink-0" />
                                                    <span>Sensores, micrófonos</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </InfoCard>
                            ...
                            <AnimatedContent direction="horizontal" distance={60} delay={0.2}>
                                <SpotlightCard className="h-full" spotlightColor="rgba(255, 89, 0, 0.3)">
                                    <InfoCard title="Salida" icon={<Signal className="w-5 h-5" />}>
                                        <p className="mb-3 text-white">
                                            <strong className="text-[var(--color-orange)]">Entregar resultados</strong> del procesamiento en forma útil.
                                        </p>
                                        <div className="p-3 rounded-lg bg-gradient-to-br from-muted/70 to-muted/30 border border-border/30">
                                            <ul className="space-y-1 text-sm">
                                                <li className="flex items-start gap-2 text-black">
                                                    <ChevronRight className="w-3 h-3 mt-0.5 text-[var(--color-orange)] flex-shrink-0" />
                                                    <span>Monitores, impresoras</span>
                                                </li>
                                                <li className="flex items-start gap-2 text-black">
                                                    <ChevronRight className="w-3 h-3 mt-0.5 text-[var(--color-orange)] flex-shrink-0" />
                                                    <span>Altavoces, proyectores</span>
                                                </li>
                                                <li className="flex items-start gap-2 text-black">
                                                    <ChevronRight className="w-3 h-3 mt-0.5 text-[var(--color-orange)] flex-shrink-0" />
                                                    <span>Actuadores, LEDs</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </InfoCard>
                            ...
                            <AnimatedContent direction="horizontal" distance={60} delay={0.3}>
                                <SpotlightCard className="h-full" spotlightColor="rgba(0, 124, 120, 0.3)">
                                    <InfoCard title="Interfaz" icon={<Workflow className="w-5 h-5" />}>
                                        <p className="mb-3 text-white">
                                            Permite la <strong className="text-[var(--color-teal-3)]">interacción</strong> entre usuarios y computadora.
                                        </p>
                                        <div className="p-3 rounded-lg bg-gradient-to-br from-muted/70 to-muted/30 border border-border/30">
                                            <ul className="space-y-1 text-sm">
                                                <li className="flex items-start gap-2 text-black">
                                                    <ChevronRight className="w-3 h-3 mt-0.5 text-[var(--color-teal-3)] flex-shrink-0" />
                                                    <span>Comunicación hombre-máquina</span>
                                                </li>
                                                <li className="flex items-start gap-2 text-black">
                                                    <ChevronRight className="w-3 h-3 mt-0.5 text-[var(--color-teal-3)] flex-shrink-0" />
                                                    <span>Dispositivos táctiles</span>
                                                </li>
                                                <li className="flex items-start gap-2 text-black">
                                                    <ChevronRight className="w-3 h-3 mt-0.5 text-[var(--color-teal-3)] flex-shrink-0" />
                                                    <span>Interfaces gráficas</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </InfoCard>
